...
[wp-download-btn url="https://downloads.wordpress.org/plugin/simple-scroll-to-top-button.zip"]

[github_btn url="https://github.com/ArthurGareginyan/simple-scroll-to-top-button"]
...
Go to the dedicated plugin page on WordPress.org: [anarcho_l_button url="https://wordpress.org/plugins/simple-scroll-to-top-button/"]

If you liked the plugin, then I'll be glad if you would appreciate or leave feedback on the site WordPress.org: [anarcho_l_button url="http://wordpress.org/support/view/plugin-reviews/simple-scroll-to-top-button"]
