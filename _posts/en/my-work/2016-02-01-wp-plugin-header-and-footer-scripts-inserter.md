...
[wp-download-btn url="https://downloads.wordpress.org/plugin/header-and-footer-scripts-inserter.zip"]
    
[github_btn url="https://github.com/ArthurGareginyan/header-and-footer-scripts-inserter"]
...
[anarcho_l_button url="https://wordpress.org/plugins/header-and-footer-scripts-inserter/"]

If you liked the plugin, then I'll be glad if you would appreciate or leave feedback on the site WordPress.org:
[anarcho_l_button url="http://wordpress.org/support/view/plugin-reviews/header-and-footer-scripts-inserter"]
