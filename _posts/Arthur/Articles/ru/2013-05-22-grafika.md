...
**Шаг 1.** Открываем файл `/etc/modprobe.d/blacklist-framebuffer` :
...
**Шаг 2.** Открываем файл `/etc/initramfs-tools/modules` :
...
**Шаг 3.** Пересобираем initramfs image
 
```sh
sudo update-initramfs -u
```

**Шаг 4.** Редактируем GRUB2
...
**Шаг 5.** Применяем изменения для Grub:
...
**Шаг 1.** Устанавливаем программу `hwinfo`
 
```sh
sudo apt-get install hwinfo
```

**Шаг 2.** Запускаем ее с ключем `--framebuffer`
